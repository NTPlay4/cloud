...
game_x64_download_url=https://raw.githubusercontent.com/ntplay4/game-server/master/0.3.3/game-server
game_x86_download_url=https://raw.githubusercontent.com/ntplay4/game-server/master/0.3.3/game-server-386
program_init_download_url=https://raw.githubusercontent.com/ntplay4/game-server/master/init/game-server.init
str_install_shell=https://raw.githubusercontent.com/ntplay4/game-server/master/install-game-server.sh
shell_update(){
    clear
    fun_clang.cn
